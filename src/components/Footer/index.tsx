    ...
    <footer className={styles.footer} data-testid="footer">
      <div className={styles.container}>
        <ul className={styles.socialMedia}>
          <li><a href="#" title="Facebook"><ImFacebook2 /></a></li>
          <li><a href="#" title="Instagram"><ImInstagram /></a></li>
          <li><a href="#" title="Twitter"><ImTwitter /></a></li>
          <li><a href="#" title="YouTube"><ImYoutube /></a></li>
        </ul>
      </div>
